...
import { ACCOUNTS, CATEGORY_LABELS } from "@/lib/accounts";
          ...
          {CATEGORIES.map((category) => {
            ...
            return (
              <Fragment key={category}>
                <tr>
                  <td colSpan={4} className="pb-1 pt-4 text-xs font-semibold text-muted-foreground first:pt-2">
                ...
                {accountsInCategory.map((a) => {
                  ...
                  return (
                    <tr key={key} className="border-b border-border/60 last:border-0">
                      <td className="py-2 pr-4 text-muted-foreground">{a.person}</td>
